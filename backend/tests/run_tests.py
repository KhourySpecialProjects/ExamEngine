...
def run_master_validation(algorithm_type="enhanced"):
    ...
    try:
        ...
        result = subprocess.run(args, cwd=os.path.dirname(__file__), capture_output=True, text=True)
...
def main():
    ...
    parser.add_argument("--algorithm", action="store_true", help="Run algorithm tests only")
    parser.add_argument("--validation", action="store_true", help="Run validation tests only")
    parser.add_argument("--original", action="store_true", help="Run original algorithm tests only")
    parser.add_argument("--enhanced-validation", action="store_true", help="Run enhanced algorithm validation only")
    parser.add_argument("--original-validation", action="store_true", help="Run original algorithm validation only")
    parser.add_argument("--all", action="store_true", help="Run all tests (default)")
    
    args = parser.parse_args()
    
    # If no specific test type is specified, run all
    if not any([args.unit, args.integration, args.algorithm, args.validation, args.original, args.enhanced_validation, args.original_validation]):
        args.all = True
