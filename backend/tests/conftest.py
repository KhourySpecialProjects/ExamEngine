...
def sample_census_data():
    ...
    return pd.DataFrame({
        ...
        'course_ref': ['CS101', 'MATH201', 'PHYS301', 'CHEM401', 'BIO501', 'CS102', 'MATH202', 'PHYS302'],
...
def sample_enrollment_data():
    ...
    return pd.DataFrame({
        'student_id': [
            'S001', 'S001', 'S001',  # Student S001 takes 3 courses
            'S002', 'S002', 'S002',  # Student S002 takes 3 courses
            'S003', 'S003',          # Student S003 takes 2 courses
            'S004', 'S004',          # Student S004 takes 2 courses
            'S005', 'S005',          # Student S005 takes 2 courses
            'S006', 'S006',          # Student S006 takes 2 courses
            'S007', 'S007',          # Student S007 takes 2 courses
            'S008', 'S008'           # Student S008 takes 2 courses
        ],
        'CRN': [
            '1001', '1002', '1003',  # S001's courses
            '1001', '1004', '1005',  # S002's courses
            '1002', '1006',          # S003's courses
            '1003', '1007',          # S004's courses
            '1004', '1008',          # S005's courses
            '1005', '1006',          # S006's courses
            '1007', '1008',          # S007's courses
            '1001', '1002'           # S008's courses
        ],
        'instructor_name': [
            'Dr. Smith', 'Dr. Smith', 'Dr. Jones',    # S001's instructors
            'Dr. Smith', 'Dr. Brown', 'Dr. Brown',    # S002's instructors
            'Dr. Smith', 'Dr. Wilson',                # S003's instructors
            'Dr. Jones', 'Dr. Wilson',                # S004's instructors
            'Dr. Brown', 'Dr. Davis',                 # S005's instructors
            'Dr. Brown', 'Dr. Wilson',                # S006's instructors
            'Dr. Wilson', 'Dr. Davis',                # S007's instructors
            'Dr. Smith', 'Dr. Smith'                  # S008's instructors
        ]
    })
...
def large_enrollment_data(large_census_data):
    ...
    for crn in large_census_data['CRN']:
        ...
        course_size = large_census_data[large_census_data['CRN'] == crn]['num_students'].iloc[0]
...
def large_classroom_data():
    ...
    rooms = [f'Room {chr(65 + i)}' for i in range(50)]  # Room A through Room Z, then Room AA, etc.
...
def mock_schedule_data():
    ...
    return pd.DataFrame({
        ...
        'Block': ['0 (9:00-11:00)', '1 (11:30-1:30)', '2 (2:00-4:00)', '3 (4:30-6:30)', '4 (7:00-9:00)'],
