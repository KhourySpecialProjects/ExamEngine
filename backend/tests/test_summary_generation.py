...
def test_summary_generation():
    ...
    try:
        ...
        conflicts_df = pd.DataFrame(
            {"Student_ID": [1, 2, 3], "violation": ["conflict", "conflict", "conflict"]}
        )
        capacity_violations = pd.DataFrame(
            {"CRN": [1, 2], "Size": [100, 50], "Capacity": [80, 40]}
        )
        ...
        result = generate_algorithm_summary(
